      ...
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="bg-lime-600 hover:bg-lime-700 text-white px-4 py-2 text-sm rounded-md transition"
          >
            Logout
          </button>
        </div>
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-lime-600 text-white px-4 py-2 rounded hover:bg-lime-700 transition w-full md:w-auto"
          >
            Kirim Pengajuan
          </button>
        </form>
